...
Given a rod of length n inches and an array price[]. The array price[i] denotes 
the value of a piece of length i. The task is to determine the maximum value
...
Output : 24
Explanation: The maximum obtainable value is 24 by cutting the rod into 8 pieces of
length 1, i.e., 8 * price[1] = 8 * 3 = 24.
